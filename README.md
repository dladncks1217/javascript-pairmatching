...
- `resources/backend-crew.md`과 `resources/frontend-crew.md` 파일을 이용한다.
...
- `Missionutils`에서 제공하는 `Randoms`, `Console` API를 활용해 구현해야 한다.
  - Random 값 추출은 `Missionutils.Randoms`의 `shuffle()`를 활용한다.
